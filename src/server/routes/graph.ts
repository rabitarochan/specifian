...
import type { Graph, GraphNode, GraphEdge, SpecMeta } from '../../shared/types.js';

/**
 * Build the wiki-link graph from a set of specs (fs-independent).
 ...
 */
export function buildGraph(specs: SpecMeta[]): Graph {
